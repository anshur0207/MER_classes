<?php include ('includes/header.php');?>
  ...
  <body>
    ...
    <div class="testbox">
      <form method="POST" action="api/database/insert2.php">
        ...
        <div class="colums">
          ...
          <div class="item">
            ...
            <input id="fathername" type="text" name="fathername" required/>
          </div>
          <div class="item">
        ...
        <div class="question">
          <label>Preferred way to contact <br>
          9631XXXXXX <br>
          merclasses2020@gmail.com </label>
         <h3> </h3>
        ...
        <div class="btn-block">
          <button type="submit" onclick="popUp()" value="Submit" >SUBMIT</button>
      </div>
    </div>
  </div> 
  <script>
